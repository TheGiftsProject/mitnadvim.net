...
br_admin = User.create(:first_name => "אלי", :last_name => "נחמה", :phone_number => "05012345678", :email => "eli@example.com", :school => bialik_rogozin, :role => 'admin')
...
matan_bar = User.create(:first_name => "מתן", :last_name => "בר", :phone_number => "054319875161", :email => "matan@example.com", :age => 28, :area => tel_aviv_area, :role => 'volunteer')
