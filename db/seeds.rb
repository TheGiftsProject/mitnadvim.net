...
br_admin = User.create(:encrypted_password => "$2a$10$AcCYW5uw6NKs.hogOZ/bDeWfBQ5W4hZCjO763tzNupHQHzaqyb2Du", :first_name => "אלי", :last_name => "נחמה", :phone_number => "05012345678", :email => "eli@example.com", :school => bialik_rogozin, :role => 'admin')
...
matan_bar = User.create(:encrypted_password => "$2a$10$AcCYW5uw6NKs.hogOZ/bDeWfBQ5W4hZCjO763tzNupHQHzaqyb2Du", :first_name => "מתן", :last_name => "בר", :phone_number => "054319875161", :email => "matan@example.com", :age => 28, :area => tel_aviv_area, :role => 'volunteer')
