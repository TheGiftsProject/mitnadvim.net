...
br_admin = User.create(
    :password_hash: '$2a$10$m0N8OR2gLz9UqZuTwVfv/eLeDjJSvBJvP2y9MP3MoesrEpAyUfaue',
    :password_salt: '$2a$10$m0N8OR2gLz9UqZuTwVfv/e',
    :role: 'admin',
    :first_name => "אלי", :last_name => "נחמה", :phone_number => "05012345678", :email => "eli@example.com", :school => bialik_rogozin)
...
matan_bar = User.create(
    :password_hash: '$2a$10$m0N8OR2gLz9UqZuTwVfv/eLeDjJSvBJvP2y9MP3MoesrEpAyUfaue',
    :password_salt: '$2a$10$m0N8OR2gLz9UqZuTwVfv/e',
    :role: 'volunteer',
    :first_name => "מתן", :last_name => "בר", :phone_number => "054319875161", :email => "matan@example.com", :birth_year => 1984, :area => tel_aviv_area)
